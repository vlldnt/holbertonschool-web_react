...
test('handleDisplayDrawer should display the notification drawer', () => {
  render(<App />);
...
test('handleHideDrawer should hide the notification drawer', () => {
  render(<App />);
...
test('logIn should update user state with email, password, and isLoggedIn', () => {
  render(<App />);
...
test('logOut should reset user state with email and password cleared and isLoggedIn set to false', () => {
  const alertMock = jest.spyOn(window, 'alert').mockImplementation(() => {});
  render(<App />);
